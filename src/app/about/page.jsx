    ...
    <div className="bg-linear-to-r from-green-50 to-blue-50">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center ">
        ...
        <div>
          ...
          <p className="text-gray-700 text-lg leading-7 mb-4">
            We provide reliable and trusted care services for children, elderly,
            and other family members. The application allows users to find and
            hire caretakers for different purposes such as babysitting, elderly
            care, or special care at home. Users can easily book services
            through the platform. The main goal of the project is to make
      ...
      <section className=" py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          {/* Heading */}
          <h2 className="text-4xl font-bold bg-linear-to-r from-orange-500 to-green-500 bg-clip-text text-transparent mb-4">
            Meet the Team
          </h2>
